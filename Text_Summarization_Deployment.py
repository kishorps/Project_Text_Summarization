...
st.subheader('After Cleaning Text data it looks like this')
st.write(clean_text)
...
summary = summarizer_luhn(parser.document,8)
luhn_summary=""
for sentence in summary:
    luhn_summary+=str(sentence)  
print(luhn_summary)

st.subheader("Model Summary with NLP")
st.write(luhn_summary)
